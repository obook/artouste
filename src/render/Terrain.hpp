...
#include "render/terrain/PointsCarte.hpp"
...
private:
    ...
    /* Maillage du relief à partir de la carte d'altitude, appelé au
       chargement. sommetsMax est le budget de sommets : le pas d'échantillonnage
       est le plus petit qui y tienne. Défini dans terrain/TerrainMaillage.cpp. */
    void construireMaillage(int sommetsMax);

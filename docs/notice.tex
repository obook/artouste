...
\hline
\textbf{Action} & \textbf{Clavier} & \textbf{Manette Xbox} \\
\hline
...
\hline
Mode assist\'e (confort) & M & croix directionnelle haut \\
\hline
...
\hline
D\'emo (lancer / sortir) & V / \texttt{\'Echap} & même bouton \texttt{Back} ou geste du manche \\
\hline
Quitter le simulateur & \texttt{\'Echap} & LB + RB \\
\hline
\end{tabularx}
...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
\hline
\textbf{Action} & \textbf{Clavier} & \textbf{Manette PlayStation} \\
\hline
...
\hline
D\'emo (lancer / sortir) & V / \texttt{\'Echap} & même bouton \texttt{Share} / \texttt{Create} ou geste du manche \\
\hline
Quitter le simulateur & \texttt{\'Echap} & L1 + R1 \\
\hline
\end{tabularx}

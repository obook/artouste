 ...
 * Commandes ponctuelles du moteur audio hors radio : suspension/reprise des
 * boucles (pause), son de démarrage de la turbine, musique de la démo et état
 * "prêt". Le cycle de vie et la modulation continue sont dans AudioEngine.cpp ;
 * la radio internet et les messages radio de synthèse vocale sont dans

...
La méthode est propre à Artouste, construite pour ce jeu, mesure par
mesure. Ses quatre choix : le
...
En un point $p$ du sol, à distance $d$ de l'œil de la fenêtre :
\begin{equation*}
...
(qui dessine à 4 fois ce pas) tombent tous deux sur les nœuds du maillage.
...
formules). Leur passage en double (\code{CalageCarte}) a aussi corrigé le

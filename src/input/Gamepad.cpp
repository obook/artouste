...
// Applique zone morte + expansion à un axe de stick brut [-1, +1].
...
// Convertit une gâchette GLFW (repos -1, fond +1) vers [0, 1].
...
physics::Controls Gamepad::poll() noexcept {
    ...
    // Stick vers le haut = Y négatif chez GLFW ; on l'inverse pour "avant = +1".
...
bool Gamepad::isActive() noexcept {
    ...
    // Gâchettes nettement enfoncées (au-delà du repos -1).
